...
function putData(codigo,nome,valor) {  
   ...
   if (codigo!= ""){   
   window.opener.document.getElementById('quant3').value = 1;   
   window.opener.document.getElementById('cdproduto3').value = codigo;  
   window.opener.document.getElementById('discriminacao3').value = nome;  
   window.opener.document.getElementById('vlunitario3').value = valor;
   window.opener.document.getElementById('vlunitario3').focus();  
   window.close();   
   }else{ 
...
<!--      <form id="form1" name="form1" method="post" action="">-->
	  <form action="pesquisar_produto3.php" method="get">
      <table width="500" cellspacing="0" cellpadding="0">
        <tr>
