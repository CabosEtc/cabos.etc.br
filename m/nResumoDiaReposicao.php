	...
	<head>
		<?
            ...
            */
			...
			$dtMovimentoInicial=$_REQUEST["dtMovimentoInicial"];
			$dtMovimentoFinal=$_REQUEST["dtMovimentoFinal"];
			...
			echo ("<title>Reposição $dtMovimentoInicial / $dtMovimentoFinal</title>");
		?>
		...
		<?
            ...
            */
			...
			echo "  <tr $backGroundTR>
                        ...
                        <td colspan='2' align='center'>Estoque</td>
                    </tr>
                    <tr $backGroundTR>
                        <td colspan='9'>&nbsp</td>
                        <td width='120' align='center'>Atual</td>
                        <td width='60' align='center'>Ideal</td>
                    </tr>";
            /*
			<td>Custo</td>
			<td>Venda</td>
            ...
            */
			...
			while ($row = mysql_fetch_array($resultadoProdutoVendidos, MYSQL_NUM)) {
              ...
              if($quantEstoqueProduto<$estoqueIdeal){
                $backGroundColor="style=\"background-color:$corMarcaTexto\""; // vem da tabela parametros
              }
              else{
                $backGroundColor="";
              }
                echo "      <td width='120'  $backGroundColor align='right' title='$titleQuantidadeEstoqueProdutoOutrasLojas'>
