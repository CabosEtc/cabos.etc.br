...
<div id="wrapper" class="wrapper">
    ...
    <table width="960" border="0" align="center">
        <tr>
            ...
            <td>Pedido</td>
            <td><input name="pedido" type="text" id="pedido" maxlength="18" onblur="pesquisarPedido();"/></td>
        ...
        <tr>
            ...
            <td colspan="2">
                ...
                <input type="button" name="BIC5" id="BIC5" value="WAL" onclick="javascript:document.getElementById('idpaypal').value='WALRAM Factory Store'" />
            </td>
            <td>&nbsp;</td>
        ...
        ?></td>
            ...
            <td><input name="cdrastreamento" type="text" id="cdrastreamento" maxlength="22" /></td>
            ...
            <td>
                <select name='endereco' id='endereco'>";
                    ...
                    if ($cdloja=="1"){
                    echo"
                        <option value='1'>1- Cabos 329</option>
                        <option value='2'>2- Cabos 212</option>
                        <option value='3'>3- Clique Retire - Flávio</option>
                        <option value='4'>4- Clique Retire - Robine</option>
                        <option value='5'>5- Cabos 318</option>";
                    }
                    if ($cdloja=="11"){ // Estoque da Supergames
                        echo"
                            <option value='1'>1- Estoque</option>";
                        }
                    ?>
                </select>
            </td>
        ...
        <tr>
            ...
            <td colspan="4"><input name="observacao" type="text" id="observacao" size="60" maxlength="128" /></td>
...
function makerequest(pedido){
    let pagina="https://www.cabos.etc.br/m/BDRotinasAjax.php?modo=buscarPedidoCompraPorPedido&pedido="+pedido;
