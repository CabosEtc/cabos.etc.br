...
function putData(codigo,nome,valor) {  
   ...
   if (codigo!= ""){   
   window.opener.document.getElementById('quant5').value = 1;   
   window.opener.document.getElementById('cdproduto5').value = codigo;  
   window.opener.document.getElementById('discriminacao5').value = nome;  
   window.opener.document.getElementById('vlunitario5').value = valor;  
   window.opener.document.getElementById('vlunitario5').focus();  
   window.close();   
   }else{ 
...
<!--      <form id="form1" name="form1" method="post" action="">-->
	  <form action="pesquisar_produto5.php" method="get">
      <table width="500" cellspacing="0" cellpadding="0">
        <tr>
