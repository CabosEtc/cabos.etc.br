<html>
  ...
  <body>
    ...
    ?>
          ...
          <div id="containerAlerta" class="container  mx-auto alert mt-2" style="display: none">
              <div class="row">
                  <div class="col-12">
    ...
    <form id="form1" name="form1" method="post" action="nrot.php">
      <div class="container mx-auto bg-warning">
        <div class="row">
          <div class="col-12">
            ...
            <input name="nrnota" type="hidden" id="nrnota" <? echo("value='".$nrnota."'"); ?> />
          </div>
        </div>
      
        <div class="row">
            <div class="col-6">
              Data de emiss&atilde;o: <? echo($dtnota); ?>
            </div>
            <div class="col-6">
              Garantia: <? echo($garantia." dias.");?>
              <input name="dtnota" type="hidden" id="dtnota" <? echo("value='".$dtnota."'"); ?> />
              <input name="garantia" type="hidden" id="garantia" <? echo("value='".$garantia."'"); ?> />
            </div>
        </div>
        ...
        <div class="row">
          <div class="col-12">
            Cliente: <input name="cdcliente" type="text" id="cdcliente" size="10" maxlength="7" readonly="readonly" <? echo("value='$cdCliente'")?>/>
          </div>
        </div>
      </div>
      ...
      <table width="960" border="0" align="center">
        ...
        <tr>
            ...
            <td><input type="checkbox" name="balcao1" value="1"></td>
          </tr>
        ...
        <tr>
          ...
          <td><input type="checkbox" name="balcao2" value="1"></td>
        </tr>
        ...
        <tr>
          ...
          <td><input type="checkbox" name="balcao3" value="1"></td>
        </tr>
        ...
        <tr>
          ...
          <td><input type="checkbox" name="balcao4" value="1"></td></tr>
        ...
        <tr>
          ...
          <td><input type="checkbox" name="balcao5" value="1"></td>
        </tr>
        ...
        <tr>
          ...
          <td><input type="checkbox" name="balcao6" value="1"></td>
        </tr>
        ...
        <tr>
          ...
          <td><input type="checkbox" name="balcao7" value="1"></td>
        </tr>
        ...
        <tr>
          ...
          <td><input type="checkbox" name="balcao8" value="1"></td>
        </tr>
        ...
        <tr>
          ...
          <td><input type="checkbox" name="balcao9" value="1"></td>
        </tr>
        ...
        <tr>
          ...
          <td><input type="checkbox" name="balcao10" value="1"></td>
        </tr>
        <?
        ...
        <tr>
          <td>&nbsp;</td>
          <td>&nbsp;</td>
          <td colspan="2" align="right">Nota sem o frete</td>
        ...
        <td>&nbsp;</td>
          ...
          <td><input name="vlfrete" id="vlfrete" type="text"  size="10" maxlength="7"  value="0" /></td>
        </tr>
        ...
        <tr>
          ...
          <td><input name="vlpago" type="text" id="vlpago" size="10" maxlength="7"/></td>
        </tr>
        ...
        <tr>
          ...
          <td>
            <select name="idformapagamento2" id="idformapagamento2">
              <?
                  $query="SELECT idformapagamento, formapagamento 
                          FROM formas_pagamento 
                          ORDER BY idformapagamento";
                  ...
                  while ($row = mysql_fetch_array($resultado, MYSQL_NUM)) {
                      $idformapagamento=$row[0]; 
                      $formapagamento=$row[1]; // descricao
                      if($idformapagamento==8){ //Deixa "Pix" marcado com padrão
                        echo("<option value='".$idformapagamento."' selected>".$formapagamento."</option>");
                      }
                      else{
                        echo("<option value='".$idformapagamento."'>".$formapagamento."</option>");
                      }
          ...
          <td><input name="vlpago2" type="text" id="vlpago2" size="10" maxlength="7"/></td>
        </tr>
      ...
      <div class="container mx-auto bg-warning">
        <div class="row">
          ...
          <div class="col-10">
            <input name="nrserial" type="text" id="nrserial" size="120" maxlength="128"  value="" />
          </div>
        </div>
      </div>
      ...
      <div class="container mx-auto">
        <div class="row">
          <div class="col-10">
            <a href="javascript:history.back()">Voltar a página anterior</a>
          </div>
          <div class="col-2">
            <input name="modo" type="hidden" id="modo" value="incluir" />
            <input name="cdloja" type="hidden" id="cdloja" <? echo"value=".$cdloja; ?> />
            <input type="button" name="submit_id" id="btn_id" value="Incluir" onclick="enviarForm()"/>
          </div>
        </div>
      </div>
    ...
    <script type="text/javascript">
        function enviarForm(){
            ...
            let formaPagamento1=document.getElementById("idformapagamento").value;
            let formaPagamento2=document.getElementById("idformapagamento2").value;

            let vlpago2=document.getElementById("vlpago2").value;
            if(isNaN(parseFloat(vlpago2))){
              vlpago2="0";
            }
            vlpago2=vlpago2.replace(",",".");
            vlpago2=parseFloat(vlpago2).toFixed(2);
            document.getElementById("vlpago2").value=vlpago2;
            //alert("vlpago2"+vlpago2);

            if((formaPagamento1==formaPagamento2)&&(vlpago2>0)){
              alert("As formas de pagamento são iguais");
              return;
            }
            let vlNota=document.getElementById("vlnota").value;
            vlNota=vlNota.replace(",",".");
            vlNota=parseFloat(vlNota).toFixed(2);

            let vlpago=document.getElementById("vlpago").value;
            if(isNaN(parseFloat(vlpago))){
              vlpago="0";
            }
            vlpago=vlpago.replace(",",".");
            vlpago=parseFloat(vlpago).toFixed(2);
            document.getElementById("vlpago").value=vlpago;

            let vlfrete=document.getElementById("vlfrete").value;
            if(isNaN(parseFloat(vlfrete))){
              vlfrete="0";
            }
            vlfrete=vlfrete.replace(",",".");
            vlfrete=parseFloat(vlfrete).toFixed(2);
            document.getElementById("vlfrete").value=vlfrete;
            

            //alert("Atenção, avaliações sendo programadas...");
            let vlTotalRecebido=parseFloat(vlpago)+parseFloat(vlpago2);
            vlTotalRecebido=parseFloat(vlTotalRecebido).toFixed(2);
            
            let vlNotaFrete=parseFloat(vlNota)+parseFloat(vlfrete);
            vlNotaFrete=parseFloat(vlNotaFrete).toFixed(2);
            //alert("vlNotaFrete:"+vlNotaFrete+" | vlTotalRecebido:"+vlTotalRecebido);
            if(vlTotalRecebido!=vlNotaFrete){
              alert("Total recebido não fecha com o total da nota!");
            }
            else{
              //alert("Vou enviar! "+formaPagamento1+" "+formaPagamento2);
              formulario.submit();
            }
        }
    </script>
