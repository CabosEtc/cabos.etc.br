...
<!--      <form id="form1" name="form1" method="post" action="">-->
	  <form action="estoque_pesquisar_produto.php" method="get">
        ...
        if ($chave<>""){
          while ($row = mysql_fetch_array($resultado, MYSQL_NUM)) {
            ...
            echo "<tr>
                  ...
                  <td width='20'> <a href='' onclick=\"putData('".$cdproduto."');\">".$cdproduto."</a></td>
            ...
            if ($tamanho_chave==13){
              ...
              echo "putData('".$cdproduto."');";
              echo "alert('Passei no javascript');";
              echo "</script>";
            }
          } // fim do while
...
<script language="Javascript" type="text/javascript"> 
    function putData(codigo) {  
        var codigo = codigo;
        //var nome = nome;
        //var valor = valor;
        //let quant=`quant${idItemPesquisa}`;
        let cdproduto=`cdproduto`;
