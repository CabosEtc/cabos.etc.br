...
<div id="wrapper" class="wrapper">
    <h3>
        Lista de Reposição de material
    </h3>

    <form action="eListaReposicao.php" method="get">
        ...
        <table width="500" border="0" align="left">
            ...
            <tr>
                <td>
                    <label for="dtMovimentoInicial">
                        Data início:
                    </label>
                </td>
                <td>
                    <input type="date" id="dtMovimentoInicial" name="dtMovimentoInicial" value="<? echo $dthoje_eua; ?>" min="2001-01-01" max="<? echo $dthoje_eua; ?>">
                </td>
            </tr>
            ...
            <tr>
                <td>
                    <label for="dtMovimentoFinal">
                        Data final:
                    </label>
                </td>
                <td>

                    <input type="date" id="dtMovimentoFinal" name="dtMovimentoFinal" value="<? echo $dthoje_eua; ?>" min="2001-01-01" max="<? echo $dthoje_eua; ?>">
                </td>
            </tr>
