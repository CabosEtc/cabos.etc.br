...
<?
    ...
    $flagServidorLocal=$_REQUEST["flagservidorlocal"];
    if($flagServidorLocal==1){
        $checkBoxServidorLocal="checked ";
    }
    else{
        $checkBoxServidorLocal="";
    }
    ...
    //$tipoVariavel=gettype($proximoProduto);
    //echo "Tipo da variavel: $tipoVariavel<br>";
    //$tamanho=strlen($proximoProduto);
    ...
    if($proximoProduto==""){
       ...
       if($flagServidorLocal=="1"){
        $iconeProximoItem=" <a href='BDJs.php?cdproduto=$proximoProduto&flagservidorlocal=1' target='_blank'>
                                <img src='../imagens/forward.png' width='32' height='32' title='Exibe Próximo item'/>
                            </a>";
       } 
       else{
        $iconeProximoItem=" <a href='BDJs.php?cdproduto=$proximoProduto' target='_blank'>
                                <img src='../imagens/forward.png' width='32' height='32' title='Exibe Próximo item'/>
                            </a>";
       }
    }
...
<div id="conteinerDireita" style="float:left; width: 600px;">
    <div>
        ...
        <?echo $iconeProximoItem?>
        <div>
            <input type='checkbox' id='servidorLocal' name='servidorLocal' data-id='' <? echo $checkBoxServidorLocal;?> value='1'/>Servidor local
        </div>
</div>
    <div>
...
<script>
    ...
    function makerequest(id,flagConsolidado, tentativaLeitura){
        ...
        if (servidor==1){
            pagina="https://www.shop156.com.br/tExtract3.php?id="+id;
        ...
        let servidorLocal=document.getElementById("servidorLocal");
        if(servidorLocal.checked){
            //alert("Usando Servidor local");
            pagina="http://localhost/tExtract3.php?id="+id;
        }
    ...
    function makeRequestConsolidado(id){
        ...
        //let pagina="http://www.cabos.etc.br/m/tConsolidados.php?cdproduto=<? echo $cdProduto; ?>";
        //console.log("pagina: "+pagina);
