...
function putData(codigo,nome,valor) {  
   ...
   if (codigo!= ""){   
   window.opener.document.getElementById('quant4').value = 1;   
   window.opener.document.getElementById('cdproduto4').value = codigo;  
   window.opener.document.getElementById('discriminacao4').value = nome;  
   window.opener.document.getElementById('vlunitario4').value = valor;  
   window.opener.document.getElementById('vlunitario4').focus();  
   window.close();   
   }else{ 
...
<!--      <form id="form1" name="form1" method="post" action="">-->
	  <form action="pesquisar_produto4.php" method="get">
      <table width="500" cellspacing="0" cellpadding="0">
        <tr>
