...
<html>
  ...
  <body>
    ...
    function consulta(campo){
      ...
      alert("� necess�rio preencher a quantidade de produtos do primeiro campo!");
      ...
      alert("� necess�rio preencher a quantidade de produtos do segundo campo!");
      ...
      alert("� necess�rio preencher a quantidade de produtos do terceiro campo!");
      ...
      alert("� necess�rio preencher a quantidade de produtos do quarto campo!");
      ...
      alert("� necess�rio preencher a quantidade de produtos do quinto campo!");
      ...
      alert("� necess�rio preencher a quantidade de produtos do sexto campo!");
      ...
      alert("� necess�rio preencher a quantidade de produtos do setimo campo!");
      ...
      alert("� necess�rio preencher a quantidade de produtos do oitavo campo!");
      ...
      alert("� necess�rio preencher a quantidade de produtos do nono campo!");
      ...
      alert("� necess�rio preencher a quantidade de produtos do decimo campo!");
      ...
      $query="SELECT parametros.nrnota, parametros.dtnota, lojas.nomeloja FROM parametros, lojas  WHERE parametros.cdloja='$cdloja' AND lojas.cdloja='$cdloja'";
      ...
      <table width="960" border="0" align="center">
        <tr>
          <td>Loja: <? echo "$abreviacao2Loja1"; ?></td>
          <td>N&ordm; 
            <label>
      ...
      <table width="960" border="0" align="center">
        <tr>
          ...
          <td><input name="cdproduto1" type="text" id="cdproduto1" size="10" maxlength="5" onblur="consulta(this);"/>
            <a href="#" onclick="window.open('pesquisar_produto.php?iditem=1','popup','resizable=no,status=no,scrollbars=no,width=900,height=600,top='+(window.innerHeight-600)/2+',left='+(window.innerWidth-900)/2+'')"><img src="../imagens/lupa.png" alt="" /></a></td>
        ...
        <tr>
          ...
          <td><input name="cdproduto2" type="text" id="cdproduto2" size="10" maxlength="5" onblur="consulta2(this);" />
            <a href="#" onclick="window.open('pesquisar_produto.php?iditem=2','popup','resizable=no,status=no,scrollbars=no,width=900,height=600,top='+(window.innerHeight-600)/2+',left='+(window.innerWidth-900)/2+'')"><img src="../imagens/lupa.png" alt="" /></a></td>
        ...
        <tr>
          ...
          <td><input name="cdproduto3" type="text" id="cdproduto3" size="10" maxlength="5" />
            <a href="#" onclick="window.open('pesquisar_produto.php?iditem=3','popup','resizable=no,status=no,scrollbars=no,width=900,height=600,top='+(window.innerHeight-600)/2+',left='+(window.innerWidth-900)/2+'')"><img src="../imagens/lupa.png" alt="" /></a></td>
        ...
        <tr>
          ...
          <td><input name="cdproduto4" type="text" id="cdproduto4" size="10" maxlength="5" />
            <a href="#" onclick="window.open('pesquisar_produto.php?iditem=4','popup','resizable=no,status=no,scrollbars=no,width=900,height=600,top='+(window.innerHeight-600)/2+',left='+(window.innerWidth-900)/2+'')"><img src="../imagens/lupa.png" alt="" /></a></td>
        ...
        <tr>
          ...
          <td><input name="cdproduto5" type="text" id="cdproduto5" size="10" maxlength="5" />
            <a href="#" onclick="window.open('pesquisar_produto.php?iditem=5','popup','resizable=no,status=no,scrollbars=no,width=900,height=600,top='+(window.innerHeight-600)/2+',left='+(window.innerWidth-900)/2+'')"><img src="../imagens/lupa.png" alt="" /></a></td>
        ...
        <tr>
          ...
          <td><input name="cdproduto6" type="text" id="cdproduto6" size="10" maxlength="5" />
            <a href="#" onclick="window.open('pesquisar_produto.php?iditem=6','popup','resizable=no,status=no,scrollbars=no,width=900,height=600,top='+(window.innerHeight-600)/2+',left='+(window.innerWidth-900)/2+'')"><img src="../imagens/lupa.png" alt="" /></a></td>
        ...
        <tr>
          ...
          <td><input name="cdproduto7" type="text" id="cdproduto7" size="10" maxlength="5" />
            <a href="#" onclick="window.open('pesquisar_produto.php?iditem=7','popup','resizable=no,status=no,scrollbars=no,width=900,height=600,top='+(window.innerHeight-600)/2+',left='+(window.innerWidth-900)/2+'')"><img src="../imagens/lupa.png" alt="" /></a></td>
        ...
        <tr>
          ...
          <td><input name="cdproduto8" type="text" id="cdproduto8" size="10" maxlength="5" />
            <a href="#" onclick="window.open('pesquisar_produto.php?iditem=8','popup','resizable=no,status=no,scrollbars=no,width=900,height=600,top='+(window.innerHeight-600)/2+',left='+(window.innerWidth-900)/2+'')"><img src="../imagens/lupa.png" alt="" /></a></td>
        ...
        <tr>
          ...
          <td><input name="cdproduto9" type="text" id="cdproduto9" size="10" maxlength="5" />
            <a href="#" onclick="window.open('pesquisar_produto.php?iditem=9','popup','resizable=no,status=no,scrollbars=no,width=900,height=600,top='+(window.innerHeight-600)/2+',left='+(window.innerWidth-900)/2+'')"><img src="../imagens/lupa.png" alt="" /></a></td>
        ...
        <tr>
          ...
          <td><input name="cdproduto10" type="text" id="cdproduto10" size="10" maxlength="5" />
            <a href="#" onclick="window.open('pesquisar_produto.php?iditem=10','popup','resizable=no,status=no,scrollbars=no,width=900,height=600,top='+(window.innerHeight-600)/2+',left='+(window.innerWidth-900)/2+'')"><img src="../imagens/lupa.png" alt="" /></a></td>
        ...
        <tr>
          <td colspan='2'>Atalho (Só o primeiro campo)</td>
        ...
        <?
          ...
          $query2=" SELECT favoritos.cdproduto,produtos.nome,precos.vlvenda 
                    ...
                    GROUP BY favoritos.cdproduto 
                    ORDER BY favoritos.cdproduto";
          //echo $query2;
