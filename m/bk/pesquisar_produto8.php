...
function putData(codigo,nome,valor) {  
   ...
   if (codigo!= ""){   
   window.opener.document.getElementById('quant8').value = 1;   
   window.opener.document.getElementById('cdproduto8').value = codigo;  
   window.opener.document.getElementById('discriminacao8').value = nome;  
   window.opener.document.getElementById('vlunitario8').value = valor;  
   window.opener.document.getElementById('vlunitario8').focus();  
   window.close();   
   }else{ 
...
<!--      <form id="form1" name="form1" method="post" action="">-->
	  <form action="pesquisar_produto8.php" method="get">
      <table width="500" cellspacing="0" cellpadding="0">
        <tr>
