<html>
    <body>
        ...
        <?php
            ...
            if ($cdLoja==""){
                echo "Código da loja não informado!";
                exit;
            }

            $queryProdutos="SELECT cdproduto, nome FROM produtos ORDER BY cdproduto";
            //$queryProdutos="SELECT cdproduto, nome FROM produtos WHERE cdproduto>='10048' ORDER BY cdproduto";
            ...
            while ($row = mysql_fetch_array($resultadoProdutos, MYSQL_NUM)) {
                ...
                if($quantidadeVendida>0){
                    ...
                    $queryAjustaQuantidade="INSERT INTO `estoque` (`iditem`, `cdloja`, `cdproduto`, `dtmovimento`, `historico`, `fornecedor`, `quantidade`, `vlindividual`, `idcompra`, `idnota`, `link`, `dados`, `observacao`) 
                                            VALUES (NULL, '4', '$cdProduto', '2023-11-06', '99', '0', $quantidadeVendida, 0, '', '', '', '', 'Inserido pela rotina de zeragem de estoque em 06/11/23');";
                ...
                if($quantidadeVendida>0){
                    ...
                    $queryAjustaQuantidade="INSERT INTO `estoque` (`iditem`, `cdloja`, `cdproduto`, `dtmovimento`, `historico`, `fornecedor`, `quantidade`, `vlindividual`, `idcompra`, `idnota`, `link`, `dados`, `observacao`) 
                                            VALUES (NULL, '10', '$cdProduto', '2023-11-06', '99', '0', $quantidadeVendida, 0, '', '', '', '', 'Inserido pela rotina de zeragem de estoque em 06/11/23');";
                    //$resultadoAjustaQuantidade=mysql_query($queryAjustaQuantidade,$conexao);
                    //echo "$queryAjustaQuantidade<br>";
                }
                else{
