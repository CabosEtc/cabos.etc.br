  ...
  $lojasEncontradas=0;
    ...
    //echo "<tr><td colspan='2'>$field</td></tr>";
      ...
      //echo "flagLojaCadastrada: $flagLojaCadastrada<br>";
       ...
       !strpos($field,"<span>R$")
		...
		//echo $field;
            ...
            $dadosLojas=$dadosLojas."\"flagpredio\":$flagPredio,\"preco\":$preco,\"rank\":1,\"idloja\":$idLoja,";
      ...
      // Rotina adicionada em 28Maio2018 para permitir guardar um snapshot de todos os precos de determinado produto na data corrente
        ...
        $dadosLojas=$dadosLojas."\"flagalteradohoje\":$flagAlteradoHoje, \"linkbd\":\"$link\"}";
...
$ret="{\"statusloja1\":$flagAtivoCabos, 
