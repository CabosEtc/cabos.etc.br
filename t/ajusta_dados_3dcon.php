<html>
    <body>
        <h2>
            Importa o codigo, quantidade, valor de compra e venda do arquivo dados.csv, na pasta t (teste) do site
        </h2>
        <?php
            ...
            if ($ponteiro) {
                while (($linha = fgets($ponteiro, 4096)) !== false){
                    ...
                    echo "$cdProduto | $nomeProdutoTabela | $quantidadeProduto<br>";
                    ...
                    IF($quantidadeItens==0){
                        ...
                        $query="INSERT INTO precos(idpreco, cdproduto, cdloja, cdsubcategoria, vlcompra, dtatualizacao,cdmoeda,vlvenda,quant_estoque_min, garantia, ativo, siteflag)
                                VALUES (NULL, '$cdproduto', 11, 1, '999.99', '2023-04-23', 'BRL', '999.99', 0, 90, 1, 0)";
                    }
                    ELSE{
                        echo "Achei preço anterior, não vou fazer nada, não tenho preço para alterar...<br>";
                    ...
                    */
                    ...
                    $queryAjustaQuantidade="INSERT INTO `estoque` (`iditem`, `cdloja`, `cdproduto`, `dtmovimento`, `historico`, `fornecedor`, `quantidade`, `vlindividual`, `idcompra`, `idnota`, `link`, `dados`, `observacao`) 
                                            VALUES (NULL, '11', '$cdProduto', '2022-04-23', '51', '0', $quantidadeProduto, '999.99', '', '', '', '', 'Inserido pela rotina de importação em 23/04/23')";
