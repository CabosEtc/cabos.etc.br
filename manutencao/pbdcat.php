...
echo "<table><tr><td>Categoria ->$descricao [".$hora." - ".$dthoje_bra."] - <b>$resultado_quant</b> produtos listados</td><td><A HREF='../manutencao/pbdcat.php?cat=$cat&pag=$nextpag'><IMG SRC='../imagens/forward.png'/></A></td></tr></table>";
...
function AbreSite ( $url ) {
  ...
  */
  ...
  // nó 0 Le a marca e o nome do produto
  
      //echo "$field<BR>";
		if(strpos($field,"<div class=\"row preco detalhe\"")){ // se a linha contem o marcador do inicio da div daquele produto
      ...
      //ECHO "Encontrei uma linha de inicio<br>";
    ...
    IF($contador_linhas==$marcador_marca){
      ...
      if(strpos($field,"<a href=\"http")){
        $inicio_marca=strpos($marca,"nofollow\">")+16;
    ...
    //ECHO "Linha-> $contador_linhas / Marcador_inicio-> $marcador_inicio_div  / Marcador nome produto -> $marcador_nome_produto -->>> $field<BR>";
      ...
      $codigo_bd_limpo=$codigo_bd;
        $link_bd="<a href='https://www.boadica.com.br/produtos/$codigo_bd_limpo'  TARGET='_blank'><img src='../imagens/coruja.png'></a>";
      //$link_incluir_bd="<a href='http://cabos.etc.br/manutencao/precos_bd_cadastro_link.php?marca=$marca&produto&link=https://www.boadica.com.br/produtos/$codigo_bd'  TARGET='_blank'><img src='../imagens/addbd.png'></a>";
    ...
    */
    ...
    // Nó 3 (loja)
      ...
      echo "<b>$codigo_bd_limpo</b> [$id] [$marca] [$produto] $link_bd<BR>";
      echo "$nome";
      
       $link_incluir_bd="<a href='http://cabos.etc.br/manutencao/precos_bd_cadastro_link.php?marca=$marca&produto=$produto&link=https://www.boadica.com.br/produtos/$codigo_bd_limpo'  TARGET='_blank'><img src='../imagens/addbd.png'></a>";
      ...
      IF($flag_produto_cadastrado=="0"){
        ...
        $query_evitar_duplicidade="DELETE FROM `log` WHERE `inf1`='$codigo_bd_limpo' AND `codigo`='301'";
        $resultado_evitar_duplicidade = mysql_query($query_evitar_duplicidade,$conexao);	
        // Insere o novo codigo_bd para providencias
        $query_inserir_log="INSERT INTO log(`idlog`, `data`,  `codigo`, `loja`, `inf1`, `inf2`, `inf3`, `inf4`) VALUES ('null', CURRENT_TIMESTAMP, '301', '1', '$codigo_bd_limpo', '$cat', '$pag', 'PBDCat')";
      ...
      //echo "CONTADOR-> $contador<BR>";
        ...
        //echo "quant itens->$quantidade_itens flag_loja_cadastrada->$flag_loja_cadastrada flag_produto_cadastrado-> $flag_produto_cadastrado preco_anterior-> $preco_anterior Preco->$preco Flag_atualizado_hoje->$flag_atualizado_hoje<BR>";
          IF (($quantidade_itens==0 OR $flag_atualizado_hoje=="0") AND $flag_loja_cadastrada=="1" AND $flag_produto_cadastrado=="1" AND $preco_anterior<>$preco){		
            ...
            $query_inserir_log="INSERT INTO log(`idlog`, `data`,  `codigo`, `loja`, `inf1`, `inf2`) VALUES ('null', CURRENT_TIMESTAMP, '200', '1', '$id', 'pbdcat')";
            $resultado_inserir_log = mysql_query($query_inserir_log,$conexao);	
          }
