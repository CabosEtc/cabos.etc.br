...
function putData(codigo,nome,valor) {  
   ...
   if (codigo!= ""){   
   window.opener.document.getElementById('quant7').value = 1;   
   window.opener.document.getElementById('cdproduto7').value = codigo;  
   window.opener.document.getElementById('discriminacao7').value = nome;  
   window.opener.document.getElementById('vlunitario7').value = valor;  
   window.opener.document.getElementById('vlunitario7').focus();  
   window.close();   
   }else{ 
...
<!--      <form id="form1" name="form1" method="post" action="">-->
	  <form action="pesquisar_produto7.php" method="get">
      <table width="500" cellspacing="0" cellpadding="0">
        <tr>
