...
<noscript>
    <div class="noscript">
        <div class="noscript-inner">
            ...
            <p>Você deve ter o JavaScript habilitado no seu navegador para usar as funcionalidades deste site.</p>
        </div>
    </div>
</noscript>
...
if ($modo=="alterar"){
	$query="UPDATE precos SET vlvenda='$vlvenda', vlvendasite='$vlvendasite', cdsubcategoria='$cdsubcategoria', vlcompra='$vlcompra', cdmoeda='$cdmoeda', ativo='$ativo', siteflag='$siteflag'  WHERE idpreco='$idpreco'";
...
<div> Código: <? echo $cdproduto; ?></div>
<div style="padding-bottom:30px;"> Nome: <? echo $nomeproduto; ?></div>

<div style="padding:5px;"><label style="width:200px; float:left; display:block;">Preço na loja:</label><input name="vlvenda" id="vlvenda" type="text" value="<? echo $vlvenda;?>" /></div>

<div style="padding:5px;"><label style="width:200px; float:left; display:block;">Preço no site:</label>
...
<div style="position:relative; margin-left:200px;"><textarea name="caracteristicas" cols="120" rows="5" id="caracteristicas" type="text" /><? echo $caracteristicas; ?></textarea>
 ...
 <div style="padding:5px;">Nota: Começar a descricao e as caracteristicas sempre com este notação &lt;lu&gt; &lt;li&gt;Linha 1&lt;/li&gt;&lt;li&gt;Linha 2&lt;/li&gt;&lt;/lu&gt;, &eacute; isto que coloca o ponto no inicio do texto.</div>
