...
$cdproduto=$_REQUEST["cd"];
if ($cdproduto<>""){
$query="SELECT produtos.nome, produtos.caracteristicas FROM produtos WHERE produtos.cdproduto='$cdproduto'";
//echo $query;
$resultado = mysql_query($query,$conexao);
$nome=mysql_result($resultado,0,0);
$caracteristicas=mysql_result($resultado,0,1);
}
?>
<div id="site">
...
<input name='busca' type='text' id='busca' size='60' maxlength='60' /><input type='submit' name='Ok' id='Ok' value='Ok' /></form></div>
        ...
        <div id="conteudo_principal" class="conteudo_principal">
            ...
            <div id="principal_right" class="principal_right">
            <div id="produto" class="produto">
                <div id="titulo" class="titulo"><? ECHO "$nome";?></div>
            </div>
            <div id="outras_informacoes" class="outras_informacoes">Outras Informacoes, bla bla bla bla bla bla</div>
            </div>
            
            <div id="principal_left" class="principal_left">
            <div id="imagem" class="imagem"><img class="imagem_centralizada" src='../imagens/produtos/hub.webp' width=400 height=400 /></div>
            <div id="descricao" class="descricao"><? ECHO "$caracteristicas"; ?></div>
            </div>
       </div>
