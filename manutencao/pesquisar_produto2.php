...
function putData(codigo,nome,valor) {  
   ...
   if (codigo!= ""){
   window.opener.document.getElementById('quant2').value = 1;    
   window.opener.document.getElementById('cdproduto2').value = codigo;  
   window.opener.document.getElementById('discriminacao2').value = nome;  
   window.opener.document.getElementById('vlunitario2').value = valor;  
   window.opener.document.getElementById('vlunitario2').focus();  
...
<!--      <form id="form1" name="form1" method="post" action="">-->
	  <form action="pesquisar_produto2.php" method="get">
      <table width="500" cellspacing="0" cellpadding="0">
        <tr>
