...
echo "<h3>Relatório de precos do Boadica (".$hora.")</h3><br>";
...
IF ($cdproduto<>""){
	$query="SELECT id, produto, link, cdproduto from links_boadica WHERE cdproduto='$cdproduto'  ORDER BY produto";
} ELSE {
	$query="SELECT id, produto, link, cdproduto from links_boadica ORDER BY produto";
		}
...
while ($row = mysql_fetch_array($resultado, MYSQL_NUM)) {
	...
	$findme="Cabos e etc";
			...
			echo "<a href='a.php?cdproduto=".$cdproduto."' TARGET='_blank'>Atualizar somente este produto ".$cdproduto."</a><BR><BR>";	
