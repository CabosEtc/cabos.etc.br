...
if ($modo=="incluir"){
	...
	$query="INSERT INTO estoque(iditem, cdproduto, historico, dtmovimento, quantidade, idcompra, cdloja) VALUES ('null', '$cdproduto', '51', '$dtchegada_eua', '$quantidade', '$iditem', '$cdloja')";
	// echo $query;
	$resultado = mysql_query($query,$conexao);
...
if ($modo=="incluir_manual"){
  ...
  echo "Quantidade: ".$quantidade."<br>";
	...
	// incluir o produto no banco de dados do estoque
	$query="INSERT INTO estoque(iditem, cdproduto, historico, fornecedor, dtmovimento, quantidade, idcompra, cdloja, vlindividual) VALUES ('null', '$cdproduto', '51', '$fornecedor', '$dtentrada_eua', '$quantidade', '0', '$cdloja', $valor)";
	echo $query;
	$resultado = mysql_query($query,$conexao);
	echo "<BR><BR><BR><a href='../manutencao/estoque_incluir_manual.php'>Incluir </a> novo produto no sistema.";
}
