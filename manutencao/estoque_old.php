...
<table width="960" border="0" align="center">
  <tr>
    <td><h3>Produtos em estoque  <? echo "(".$nomeloja.")"; ?>
      <br />
      <br />
    </h3>      
<?
...
//	if ($favorito=="1"){
		$sub_query="SELECT produtos.nome, precos.cdproduto FROM precos, produtos WHERE precos.cdproduto=produtos.cdproduto AND cdcategoria='".$cdcategoria."' AND precos.cdloja='".$cdloja."' ORDER BY produtos.nome";
//	}
//		else {
...
//	echo $sub_query;
	...
	echo "<tr><td colspan='3' bgcolor='#FFFF00'>Produto</td><td colspan='5' bgcolor='#FF66FF' align='center'>Movimento da Loja</td></tr>";
...
//	echo "<tr><td width='300'>Nome do Produto</td><td width='30'>Código</td><td width='60' align='right'>Entradas</td><td width='60' align='right'>Transf.</td><td width='60' align='right'>Perdas</td><td width='90' align='right'>Estoque</td><td width='90' align='right'>Entradas</td><td width='90' align='right'>Vendidos</td><td width='90' align='right'>Estoque</td><td width='50' align='right'>Valor</td><td width='60' align='right'>Estoque</td><td width='60' align='right'>E\$toque</td><td width='70' align='right'>A chegar</td><td align='center'>Comprar</td></tr>";
	...
	echo "<tr><td width='300'>Nome do Produto</td><td width='30'>Código</td><td width='30'>Valor Unitário</td>  <td width='60' align='right'>Entradas</td><td width='60' align='right'>Ajustes/perdas</td><td width='60' align='right'>Vendas</td><td width='60' align='right'>Quantidade em Estoque</td><td width='60' align='right'>E\$toque</td></tr>";
...
/*
		$sub_query2="SELECT sum(quantidade) as a_chegar from compras WHERE cdproduto='".$cdproduto."' and cdstatus='0'";
		//  echo $sub_query2;
...
*/
		...
		//echo $sub_query3;
		$sub_resultado3 = mysql_query($sub_query3,$conexao);
		$entradas=mysql_result($sub_resultado3,0,0);
		...
		//echo $sub_query3;
		$sub_resultado4 = mysql_query($sub_query4,$conexao);
		$saidas=mysql_result($sub_resultado4,0,0);
		...
		// echo $sub_query5;
		$sub_resultado5 = mysql_query($sub_query5,$conexao);
		$quantidade_vendida=mysql_result($sub_resultado5,0,0);
		...
		$quantidade_estoque=$entradas-$saidas-$quantidade_vendida;
...
echo "<tr bgcolor='".$cor."'><td>".$nome."</td><td><a href='produtos_editar.php?cdproduto=".$cdproduto."'>".$cdproduto."</a></td><td align='right'>".number_format($vlvenda,2,',','')."</td><td align='right'>".$entradas."</td><td align='right'>".$saidas."</td><td align='right'>".$quantidade_vendida."</td><td align='right'>".$quantidade_estoque."</td><td align='right'>".number_format($vltotalproduto,2,',','')."</td></tr>";
