...
$q30diasatras=date('Y-m-d', strtotime("-30 days",strtotime($hoje))); 
...
<table width="960" border="0" align="center">
  <tr>
    <td><h3>Produtos em estoque, sem venda a mais de 30 dias  <? echo "(".$nomeloja.")"; ?>
      <br>
      <br>
    </h3>      
<?
...
//	echo $sub_query;
	...
	echo "<tr><td colspan='2' bgcolor='#FFFF00'>Produto</td><td colspan='4' bgcolor='#FFA500' align='center'>Movimento do Estoque</td><td colspan='4' bgcolor='#FF66FF' align='center'>Movimento da Loja</td><td bgcolor='#00FF00' align='center'>Total</td><td bgcolor='#FFC125' align='center'>Dt ultima</td></tr>";
...
// Contagem do estoque
		...
		// Historico da ultima venda deste produto
		$sub_query10="SELECT max( dtnota ) FROM notas, notas_detalhes WHERE notas.idnota = notas_detalhes.idnota AND notas.cdloja = '1'
AND notas_detalhes.cdproduto = '".$cdproduto."'";
		$sub_resultado10 = mysql_query($sub_query10,$conexao);
		$dtultimavenda=mysql_result($sub_resultado10,0,0);
