...
function putData(codigo,nome,valor) {  
   ...
   if (codigo!= ""){   
   window.opener.document.getElementById('quant9').value = 1;   
   window.opener.document.getElementById('cdproduto9').value = codigo;  
   window.opener.document.getElementById('discriminacao9').value = nome;  
   window.opener.document.getElementById('vlunitario9').value = valor;  
   window.opener.document.getElementById('vlunitario9').focus();  
   window.close();   
   }else{ 
...
<!--      <form id="form1" name="form1" method="post" action="">-->
	  <form action="pesquisar_produto9.php" method="get">
      <table width="500" cellspacing="0" cellpadding="0">
        <tr>
