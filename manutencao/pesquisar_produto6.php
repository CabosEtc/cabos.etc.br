...
function putData(codigo,nome,valor) {  
   ...
   if (codigo!= ""){   
   window.opener.document.getElementById('quant6').value = 1;   
   window.opener.document.getElementById('cdproduto6').value = codigo;  
   window.opener.document.getElementById('discriminacao6').value = nome;  
   window.opener.document.getElementById('vlunitario6').value = valor;  
   window.opener.document.getElementById('vlunitario6').focus();  
   window.close();   
   }else{ 
...
<!--      <form id="form1" name="form1" method="post" action="">-->
	  <form action="pesquisar_produto6.php" method="get">
      <table width="500" cellspacing="0" cellpadding="0">
        <tr>
