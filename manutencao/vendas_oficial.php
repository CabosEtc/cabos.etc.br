...
$query="SELECT nrnota_oficial, dtnota_oficial FROM parametros  WHERE cdloja='".$cdloja."'";
$resultado = mysql_query($query,$conexao);
...
<table width="960" border="0" align="center">
  <tr>
    <td>* Vendas notas fiscais</td>
  </tr>
</table>
<p>&nbsp;</p>
<form id="form_venda" name="form_venda" method="post" action="../manutencao/vendas_oficial_visualizacao.php" onsubmit="return valida();">
<table width="960" border="0" align="center">
  <tr>
    <td>&nbsp;</td>
    <td>N&ordm; 
